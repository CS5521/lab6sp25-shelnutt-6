...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       b:	c7 44 24 04 4e 45 00 	movl   $0x454e,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 4f 41 00 00       	call   416a <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 59 45 00 00 	movl   $0x4559,(%esp)
      22:	e8 2b 40 00 00       	call   4052 <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 98 64 00 00       	mov    0x6498,%eax
      30:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 2a 41 00 00       	call   416a <printf>
    exit();
      40:	e8 a5 3f 00 00       	call   3fea <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 59 45 00 00 	movl   $0x4559,(%esp)
      4c:	e8 09 40 00 00       	call   405a <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 98 64 00 00       	mov    0x6498,%eax
      5a:	c7 44 24 04 6f 45 00 	movl   $0x456f,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 00 41 00 00       	call   416a <printf>
    exit();
      6a:	e8 7b 3f 00 00       	call   3fea <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 85 45 00 00 	movl   $0x4585,(%esp)
      76:	e8 bf 3f 00 00       	call   403a <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 98 64 00 00       	mov    0x6498,%eax
      84:	c7 44 24 04 90 45 00 	movl   $0x4590,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 d6 40 00 00       	call   416a <printf>
    exit();
      94:	e8 51 3f 00 00       	call   3fea <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 aa 45 00 00 	movl   $0x45aa,(%esp)
      a0:	e8 b5 3f 00 00       	call   405a <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 98 64 00 00       	mov    0x6498,%eax
      ae:	c7 44 24 04 ac 45 00 	movl   $0x45ac,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 ac 40 00 00       	call   416a <printf>
    exit();
      be:	e8 27 3f 00 00       	call   3fea <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 98 64 00 00       	mov    0x6498,%eax
      c8:	c7 44 24 04 bc 45 00 	movl   $0x45bc,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 92 40 00 00       	call   416a <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 98 64 00 00       	mov    0x6498,%eax
      e5:	c7 44 24 04 ca 45 00 	movl   $0x45ca,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 75 40 00 00       	call   416a <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 98 64 00 00       	mov    0x6498,%eax
     108:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 52 40 00 00       	call   416a <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 59 45 00 00 	movl   $0x4559,(%esp)
     12e:	e8 1f 3f 00 00       	call   4052 <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 98 64 00 00       	mov    0x6498,%eax
     13c:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 1e 40 00 00       	call   416a <printf>
      exit();
     14c:	e8 99 3e 00 00       	call   3fea <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 59 45 00 00 	movl   $0x4559,(%esp)
     158:	e8 fd 3e 00 00       	call   405a <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 98 64 00 00       	mov    0x6498,%eax
     166:	c7 44 24 04 e6 45 00 	movl   $0x45e6,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 f4 3f 00 00       	call   416a <printf>
      exit();
     176:	e8 6f 3e 00 00       	call   3fea <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 85 45 00 00 	movl   $0x4585,(%esp)
     182:	e8 b3 3e 00 00       	call   403a <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 98 64 00 00       	mov    0x6498,%eax
     190:	c7 44 24 04 90 45 00 	movl   $0x4590,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 ca 3f 00 00       	call   416a <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 98 64 00 00       	mov    0x6498,%eax
     1b4:	c7 44 24 04 fa 45 00 	movl   $0x45fa,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 a6 3f 00 00       	call   416a <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 98 64 00 00       	mov    0x6498,%eax
     1d1:	c7 44 24 04 0c 46 00 	movl   $0x460c,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 89 3f 00 00       	call   416a <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 1b 46 00 00 	movl   $0x461b,(%esp)
     1e8:	e8 65 3e 00 00       	call   4052 <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 98 64 00 00       	mov    0x6498,%eax
     1f6:	c7 44 24 04 21 46 00 	movl   $0x4621,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 64 3f 00 00       	call   416a <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 98 64 00 00       	mov    0x6498,%eax
     21e:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 3c 3f 00 00       	call   416a <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 1b 46 00 00 	movl   $0x461b,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 98 64 00 00       	mov    0x6498,%eax
     25b:	c7 44 24 04 38 46 00 	movl   $0x4638,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 ff 3e 00 00       	call   416a <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 1b 46 00 00 	movl   $0x461b,(%esp)
     288:	e8 ad 3d 00 00       	call   403a <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 98 64 00 00       	mov    0x6498,%eax
     296:	c7 44 24 04 5c 46 00 	movl   $0x465c,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 c4 3e 00 00       	call   416a <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 98 64 00 00       	mov    0x6498,%eax
     2b5:	c7 44 24 04 6b 46 00 	movl   $0x466b,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 a5 3e 00 00       	call   416a <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 98 64 00 00       	mov    0x6498,%eax
     2d2:	c7 44 24 04 7d 46 00 	movl   $0x467d,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 88 3e 00 00       	call   416a <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 38 45 00 00 	movl   $0x4538,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 98 64 00 00       	mov    0x6498,%eax
     304:	c7 44 24 04 88 46 00 	movl   $0x4688,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 56 3e 00 00       	call   416a <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 9b 46 00 00 	movl   $0x469b,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 98 64 00 00       	mov    0x6498,%eax
     346:	c7 44 24 04 a8 46 00 	movl   $0x46a8,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 14 3e 00 00       	call   416a <printf>
    exit();
     356:	e8 8f 3c 00 00       	call   3fea <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 98 64 00 00       	mov    0x6498,%eax
     360:	c7 44 24 04 c6 46 00 	movl   $0x46c6,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 fa 3d 00 00       	call   416a <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 98 64 00 00       	mov    0x6498,%eax
     37d:	c7 44 24 04 d4 46 00 	movl   $0x46d4,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 dd 3d 00 00       	call   416a <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 e5 46 00 00 	movl   $0x46e5,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 98 64 00 00       	mov    0x6498,%eax
     3af:	c7 44 24 04 eb 46 00 	movl   $0x46eb,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 ab 3d 00 00       	call   416a <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 98 64 00 00       	mov    0x6498,%eax
     3d0:	c7 44 24 04 06 47 00 	movl   $0x4706,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 8a 3d 00 00       	call   416a <printf>
    exit();
     3e0:	e8 05 3c 00 00       	call   3fea <exit>
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     3e5:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     3ec:	00 
     3ed:	c7 44 24 04 22 47 00 	movl   $0x4722,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 98 64 00 00       	mov    0x6498,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 30 47 00 	movl   $0x4730,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 49 3d 00 00       	call   416a <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 54 47 00 	movl   $0x4754,0x4(%esp)
     435:	00 
     ...
     446:	a1 98 64 00 00       	mov    0x6498,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 60 47 00 	movl   $0x4760,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 08 3d 00 00       	call   416a <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     475:	a1 98 64 00 00       	mov    0x6498,%eax
     47a:	c7 44 24 04 84 47 00 	movl   $0x4784,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 e0 3c 00 00       	call   416a <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 e5 46 00 00 	movl   $0x46e5,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b2:	a1 98 64 00 00       	mov    0x6498,%eax
     4b7:	c7 44 24 04 8f 47 00 	movl   $0x478f,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 a3 3c 00 00       	call   416a <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 98 64 00 00       	mov    0x6498,%eax
     4f5:	c7 44 24 04 a8 47 00 	movl   $0x47a8,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 65 3c 00 00       	call   416a <printf>
    exit();
     505:	e8 e0 3a 00 00       	call   3fea <exit>
    printf(stdout, "read succeeded ok\n");
     50a:	a1 98 64 00 00       	mov    0x6498,%eax
     50f:	c7 44 24 04 c3 47 00 	movl   $0x47c3,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 4b 3c 00 00       	call   416a <printf>
  } else {
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 e5 46 00 00 	movl   $0x46e5,(%esp)
    ...
    printf(stdout, "read failed\n");
     53c:	a1 98 64 00 00       	mov    0x6498,%eax
     541:	c7 44 24 04 d6 47 00 	movl   $0x47d6,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 19 3c 00 00       	call   416a <printf>
    exit();
     551:	e8 94 3a 00 00       	call   3fea <exit>
    printf(stdout, "unlink small failed\n");
     556:	a1 98 64 00 00       	mov    0x6498,%eax
     55b:	c7 44 24 04 e3 47 00 	movl   $0x47e3,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 ff 3b 00 00       	call   416a <printf>
    exit();
     56b:	e8 7a 3a 00 00       	call   3fea <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 98 64 00 00       	mov    0x6498,%eax
     575:	c7 44 24 04 f8 47 00 	movl   $0x47f8,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 e5 3b 00 00       	call   416a <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 98 64 00 00       	mov    0x6498,%eax
     592:	c7 44 24 04 0c 48 00 	movl   $0x480c,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 c8 3b 00 00       	call   416a <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 1c 48 00 00 	movl   $0x481c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 98 64 00 00       	mov    0x6498,%eax
     5c4:	c7 44 24 04 20 48 00 	movl   $0x4820,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 96 3b 00 00       	call   416a <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60e:	a1 98 64 00 00       	mov    0x6498,%eax
     613:	8b 55 f4             	mov    -0xc(%ebp),%edx
     616:	89 54 24 08          	mov    %edx,0x8(%esp)
     61a:	c7 44 24 04 3a 48 00 	movl   $0x483a,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 40 3b 00 00       	call   416a <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 1c 48 00 00 	movl   $0x481c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     665:	a1 98 64 00 00       	mov    0x6498,%eax
     66a:	c7 44 24 04 58 48 00 	movl   $0x4858,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 f0 3a 00 00       	call   416a <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6b3:	a1 98 64 00 00       	mov    0x6498,%eax
     6b8:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bb:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bf:	c7 44 24 04 71 48 00 	movl   $0x4871,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 9b 3a 00 00       	call   416a <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6e0:	c7 04 24 1c 48 00 00 	movl   $0x481c,(%esp)
     ...
     6ff:	a1 98 64 00 00       	mov    0x6498,%eax
     704:	8b 55 f4             	mov    -0xc(%ebp),%edx
     707:	89 54 24 08          	mov    %edx,0x8(%esp)
     70b:	c7 44 24 04 8e 48 00 	movl   $0x488e,0x4(%esp)
     712:	00 
     713:	89 04 24             	mov    %eax,(%esp)
     716:	e8 4f 3a 00 00       	call   416a <printf>
      exit();
    ...
    printf(stdout, "unlink big failed\n");
     761:	a1 98 64 00 00       	mov    0x6498,%eax
     766:	c7 44 24 04 c0 48 00 	movl   $0x48c0,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 f4 39 00 00       	call   416a <printf>
    exit();
     776:	e8 6f 38 00 00       	call   3fea <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 98 64 00 00       	mov    0x6498,%eax
     780:	c7 44 24 04 d3 48 00 	movl   $0x48d3,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 da 39 00 00       	call   416a <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     798:	a1 98 64 00 00       	mov    0x6498,%eax
     79d:	c7 44 24 04 e4 48 00 	movl   $0x48e4,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 bd 39 00 00       	call   416a <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     833:	a1 98 64 00 00       	mov    0x6498,%eax
     838:	c7 44 24 04 0c 49 00 	movl   $0x490c,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 22 39 00 00       	call   416a <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     850:	a1 98 64 00 00       	mov    0x6498,%eax
     855:	c7 44 24 04 32 49 00 	movl   $0x4932,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 05 39 00 00       	call   416a <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 3e 49 00 00 	movl   $0x493e,(%esp)
     86c:	e8 e1 37 00 00       	call   4052 <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 98 64 00 00       	mov    0x6498,%eax
     87a:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 e0 38 00 00       	call   416a <printf>
    exit();
     88a:	e8 5b 37 00 00       	call   3fea <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 3e 49 00 00 	movl   $0x493e,(%esp)
     896:	e8 bf 37 00 00       	call   405a <chdir>
     89b:	85 c0                	test   %eax,%eax
     89d:	79 1a                	jns    8b9 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89f:	a1 98 64 00 00       	mov    0x6498,%eax
     8a4:	c7 44 24 04 43 49 00 	movl   $0x4943,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 b6 38 00 00       	call   416a <printf>
    exit();
     8b4:	e8 31 37 00 00       	call   3fea <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 56 49 00 00 	movl   $0x4956,(%esp)
     8c0:	e8 95 37 00 00       	call   405a <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 98 64 00 00       	mov    0x6498,%eax
     8ce:	c7 44 24 04 59 49 00 	movl   $0x4959,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 8c 38 00 00       	call   416a <printf>
    exit();
     8de:	e8 07 37 00 00       	call   3fea <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 3e 49 00 00 	movl   $0x493e,(%esp)
     8ea:	e8 4b 37 00 00       	call   403a <unlink>
     8ef:	85 c0                	test   %eax,%eax
     8f1:	79 1a                	jns    90d <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f3:	a1 98 64 00 00       	mov    0x6498,%eax
     8f8:	c7 44 24 04 6a 49 00 	movl   $0x496a,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 62 38 00 00       	call   416a <printf>
    exit();
     908:	e8 dd 36 00 00       	call   3fea <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 98 64 00 00       	mov    0x6498,%eax
     912:	c7 44 24 04 7e 49 00 	movl   $0x497e,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 48 38 00 00       	call   416a <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     92a:	a1 98 64 00 00       	mov    0x6498,%eax
     92f:	c7 44 24 04 8d 49 00 	movl   $0x498d,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 2b 38 00 00       	call   416a <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 84 64 00 	movl   $0x6484,0x4(%esp)
     946:	00 
     947:	c7 04 24 38 45 00 00 	movl   $0x4538,(%esp)
     94e:	e8 cf 36 00 00       	call   4022 <exec>
     953:	85 c0                	test   %eax,%eax
     955:	79 1a                	jns    971 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     957:	a1 98 64 00 00       	mov    0x6498,%eax
     95c:	c7 44 24 04 98 49 00 	movl   $0x4998,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 fe 37 00 00       	call   416a <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 aa 49 00 	movl   $0x49aa,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 ce 37 00 00       	call   416a <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a1a:	c7 44 24 04 b9 49 00 	movl   $0x49b9,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 3c 37 00 00       	call   416a <printf>
        exit();
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a90:	c7 44 24 04 c7 49 00 	movl   $0x49c7,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 c6 36 00 00       	call   416a <printf>
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 d5 49 00 	movl   $0x49d5,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 50 36 00 00       	call   416a <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 fb 49 00 	movl   $0x49fb,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 27 36 00 00       	call   416a <printf>
     b43:	eb 19                	jmp    b5e <pipe1+0x1eb>
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 ec 49 00 	movl   $0x49ec,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 11 36 00 00       	call   416a <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 05 4a 00 	movl   $0x4a05,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 f0 35 00 00       	call   416a <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc8:	00 
     bc9:	c7 44 24 04 0f 4a 00 	movl   $0x4a0f,0x4(%esp)
     bd0:	00 
     ...
     bde:	c7 44 24 04 11 4a 00 	movl   $0x4a11,0x4(%esp)
     be5:	00 
     be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bed:	e8 78 35 00 00       	call   416a <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 25 4a 00 	movl   $0x4a25,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 2c 35 00 00       	call   416a <printf>
  ...
  printf(1, "kill... ");
     c4b:	c7 44 24 04 38 4a 00 	movl   $0x4a38,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 0b 35 00 00       	call   416a <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c80:	c7 44 24 04 41 4a 00 	movl   $0x4a41,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 d6 34 00 00       	call   416a <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 4a 4a 00 	movl   $0x4a4a,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 b3 34 00 00       	call   416a <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd4:	79 16                	jns    cec <exitwait+0x33>
      printf(1, "fork failed\n");
     cd6:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
     cdd:	00 
     cde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce5:	e8 80 34 00 00       	call   416a <printf>
      return;
    ...
    if(pid){
     ...
     cfc:	c7 44 24 04 56 4a 00 	movl   $0x4a56,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 5a 34 00 00       	call   416a <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 66 4a 00 	movl   $0x4a66,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 35 34 00 00       	call   416a <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 73 4a 00 	movl   $0x4a73,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 19 34 00 00       	call   416a <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 c8 36 00 00       	call   4456 <malloc>
    ...
    while(m1){
     ...
     da7:	e8 71 35 00 00       	call   431d <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df7:	e8 21 35 00 00       	call   431d <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 97 4a 00 	movl   $0x4a97,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 5a 33 00 00       	call   416a <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 9f 4a 00 	movl   $0x4a9f,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 34 33 00 00       	call   416a <printf>

  unlink("sharedfd");
     e36:	c7 04 24 ae 4a 00 00 	movl   $0x4aae,(%esp)
     e3d:	e8 f8 31 00 00       	call   403a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 ae 4a 00 00 	movl   $0x4aae,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 b8 4a 00 	movl   $0x4ab8,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 f7 32 00 00       	call   416a <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed1:	c7 44 24 04 e4 4a 00 	movl   $0x4ae4,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 85 32 00 00       	call   416a <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f16:	00 
     f17:	c7 04 24 ae 4a 00 00 	movl   $0x4aae,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 04 4b 00 	movl   $0x4b04,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 2a 32 00 00       	call   416a <printf>
    return;
  ...
  unlink("sharedfd");
     fbd:	c7 04 24 ae 4a 00 00 	movl   $0x4aae,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 2f 4b 00 	movl   $0x4b2f,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 7b 31 00 00       	call   416a <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 3c 4b 00 	movl   $0x4b3c,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 57 31 00 00       	call   416a <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 51 4b 00 00 	movl   $0x4b51,-0x38(%ebp)
    1027:	c7 45 cc 54 4b 00 00 	movl   $0x4b54,-0x34(%ebp)
    102e:	c7 45 d0 57 4b 00 00 	movl   $0x4b57,-0x30(%ebp)
    1035:	c7 45 d4 5a 4b 00 00 	movl   $0x4b5a,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 5d 4b 00 	movl   $0x4b5d,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 1a 31 00 00       	call   416a <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 d7 30 00 00       	call   416a <printf>
      exit();
    ...
    10be:	c7 44 24 04 6d 4b 00 	movl   $0x4b6d,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 98 30 00 00       	call   416a <printf>
        exit();
    ...
    112c:	c7 44 24 04 7c 4b 00 	movl   $0x4b7c,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 2a 30 00 00       	call   416a <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 8d 4b 00 	movl   $0x4b8d,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 86 2f 00 00       	call   416a <printf>
          exit();
    ...
    123a:	c7 44 24 04 99 4b 00 	movl   $0x4b99,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 1c 2f 00 00       	call   416a <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 aa 4b 00 	movl   $0x4baa,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 ea 2e 00 00       	call   416a <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1288:	c7 44 24 04 b8 4b 00 	movl   $0x4bb8,0x4(%esp)
    128f:	00 
    1290:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1297:	e8 ce 2e 00 00       	call   416a <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12b4:	79 19                	jns    12cf <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b6:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
    12bd:	00 
    12be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c5:	e8 a0 2e 00 00       	call   416a <printf>
      exit();
    ...
    1315:	79 19                	jns    1330 <createdelete+0xae>
          printf(1, "create failed\n");
    1317:	c7 44 24 04 6d 4b 00 	movl   $0x4b6d,0x4(%esp)
    131e:	00 
    131f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1326:	e8 3f 2e 00 00       	call   416a <printf>
          exit();
    ...
    136c:	c7 44 24 04 5c 46 00 	movl   $0x465c,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 ea 2d 00 00       	call   416a <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1429:	c7 44 24 04 cc 4b 00 	movl   $0x4bcc,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 2d 2d 00 00       	call   416a <printf>
        exit();
    ...
    145b:	c7 44 24 04 f0 4b 00 	movl   $0x4bf0,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 fb 2c 00 00       	call   416a <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 10 4c 00 	movl   $0x4c10,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 72 2c 00 00       	call   416a <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 21 4c 00 	movl   $0x4c21,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 56 2c 00 00       	call   416a <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 32 4c 00 00 	movl   $0x4c32,(%esp)
  ...
  if(fd < 0){
    ...
    1531:	c7 44 24 04 3d 4c 00 	movl   $0x4c3d,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 25 2c 00 00       	call   416a <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1551:	00 
    1552:	c7 44 24 04 57 4c 00 	movl   $0x4c57,0x4(%esp)
    1559:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1577:	00 
    1578:	c7 04 24 32 4c 00 00 	movl   $0x4c32,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    162c:	c7 44 24 04 93 4c 00 	movl   $0x4c93,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 2a 2b 00 00       	call   416a <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    1650:	c7 44 24 04 aa 4c 00 	movl   $0x4caa,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 06 2b 00 00       	call   416a <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1689:	c7 44 24 04 c1 4c 00 	movl   $0x4cc1,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 cd 2a 00 00       	call   416a <printf>
    exit();
  ...
  unlink("unlinkread");
    16ad:	c7 04 24 32 4c 00 00 	movl   $0x4c32,(%esp)
    16b4:	e8 81 29 00 00       	call   403a <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 da 4c 00 	movl   $0x4cda,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 9d 2a 00 00       	call   416a <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 e9 4c 00 	movl   $0x4ce9,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 81 2a 00 00       	call   416a <printf>

  unlink("lf1");
    16e9:	c7 04 24 f3 4c 00 00 	movl   $0x4cf3,(%esp)
    16f0:	e8 45 29 00 00       	call   403a <unlink>
  unlink("lf2");
    16f5:	c7 04 24 f7 4c 00 00 	movl   $0x4cf7,(%esp)
    16fc:	e8 39 29 00 00       	call   403a <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 f3 4c 00 00 	movl   $0x4cf3,(%esp)
  ...
  if(fd < 0){
    ...
    171e:	c7 44 24 04 fb 4c 00 	movl   $0x4cfb,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 38 2a 00 00       	call   416a <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    173e:	00 
    173f:	c7 44 24 04 57 4c 00 	movl   $0x4c57,0x4(%esp)
    1746:	00 
    ...
    1757:	c7 44 24 04 0e 4d 00 	movl   $0x4d0e,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 ff 29 00 00       	call   416a <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17f0:	00 
    17f1:	c7 04 24 f7 4c 00 00 	movl   $0x4cf7,(%esp)
  ...
  if(fd < 0){
    ...
    1806:	c7 44 24 04 5d 4d 00 	movl   $0x4d5d,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 50 29 00 00       	call   416a <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    183f:	c7 44 24 04 6e 4d 00 	movl   $0x4d6e,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 17 29 00 00       	call   416a <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 f7 4c 00 	movl   $0x4cf7,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 f7 4c 00 00 	movl   $0x4cf7,(%esp)
    1872:	e8 d3 27 00 00       	call   404a <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 7f 4d 00 	movl   $0x4d7f,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 db 28 00 00       	call   416a <printf>
    exit();
    188f:	e8 56 27 00 00       	call   3fea <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 f7 4c 00 00 	movl   $0x4cf7,(%esp)
    189b:	e8 9a 27 00 00       	call   403a <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 f3 4c 00 	movl   $0x4cf3,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 f7 4c 00 00 	movl   $0x4cf7,(%esp)
    18af:	e8 96 27 00 00       	call   404a <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 a0 4d 00 	movl   $0x4da0,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 9e 28 00 00       	call   416a <printf>
    exit();
    18cc:	e8 19 27 00 00       	call   3fea <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 f3 4c 00 	movl   $0x4cf3,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 c3 4d 00 00 	movl   $0x4dc3,(%esp)
    18e0:	e8 65 27 00 00       	call   404a <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 c5 4d 00 	movl   $0x4dc5,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 6d 28 00 00       	call   416a <printf>
    exit();
    18fd:	e8 e8 26 00 00       	call   3fea <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 e1 4d 00 	movl   $0x4de1,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 54 28 00 00       	call   416a <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 ee 4d 00 	movl   $0x4dee,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 38 28 00 00       	call   416a <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1991:	c7 04 24 fe 4d 00 00 	movl   $0x4dfe,(%esp)
    ...
    19d4:	c7 04 24 fe 4d 00 00 	movl   $0x4dfe,(%esp)
    ...
    1a05:	c7 44 24 04 01 4e 00 	movl   $0x4e01,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 51 27 00 00       	call   416a <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a69:	00 
    1a6a:	c7 04 24 c3 4d 00 00 	movl   $0x4dc3,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 1d 4e 00 	movl   $0x4e1d,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 8a 26 00 00       	call   416a <printf>
        exit();
    ...
    1afe:	c7 44 24 04 36 4e 00 	movl   $0x4e36,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 58 26 00 00       	call   416a <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b59:	c7 44 24 04 54 4e 00 	movl   $0x4e54,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 fd 25 00 00       	call   416a <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 c1 25 00 00       	call   416a <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 85 4e 00 	movl   $0x4e85,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 a1 24 00 00       	call   416a <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 93 4e 00 	movl   $0x4e93,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 85 24 00 00       	call   416a <printf>

  unlink("x");
    1ce5:	c7 04 24 0f 4a 00 00 	movl   $0x4a0f,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 57 24 00 00       	call   416a <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 0f 4a 00 00 	movl   $0x4a0f,(%esp)
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 0f 4a 00 	movl   $0x4a0f,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 a4 4e 00 00 	movl   $0x4ea4,(%esp)
    1db0:	e8 95 22 00 00       	call   404a <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 0f 4a 00 00 	movl   $0x4a0f,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 a8 4e 00 	movl   $0x4ea8,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 73 23 00 00       	call   416a <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 b7 4e 00 	movl   $0x4eb7,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 57 23 00 00       	call   416a <printf>
  unlink("bd");
    1e13:	c7 04 24 c4 4e 00 00 	movl   $0x4ec4,(%esp)
    1e1a:	e8 1b 22 00 00       	call   403a <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 c4 4e 00 00 	movl   $0x4ec4,(%esp)
  ...
  if(fd < 0){
    ...
    1e3c:	c7 44 24 04 c7 4e 00 	movl   $0x4ec7,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 1a 23 00 00       	call   416a <printf>
    exit();
  ...
  unlink("bd");
    1ed6:	c7 04 24 c4 4e 00 00 	movl   $0x4ec4,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f2a:	c7 44 24 04 f1 4e 00 	movl   $0x4ef1,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 2c 22 00 00       	call   416a <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 06 4f 00 	movl   $0x4f06,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 06 22 00 00       	call   416a <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 11 4f 00 	movl   $0x4f11,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 ea 21 00 00       	call   416a <printf>

  unlink("ff");
    1f80:	c7 04 24 1e 4f 00 00 	movl   $0x4f1e,(%esp)
    1f87:	e8 ae 20 00 00       	call   403a <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 21 4f 00 00 	movl   $0x4f21,(%esp)
    1f93:	e8 ba 20 00 00       	call   4052 <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 24 4f 00 	movl   $0x4f24,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 ba 21 00 00       	call   416a <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbc:	00 
    1fbd:	c7 04 24 3c 4f 00 00 	movl   $0x4f3c,(%esp)
  ...
  if(fd < 0){
    ...
    1fd2:	c7 44 24 04 42 4f 00 	movl   $0x4f42,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 84 21 00 00       	call   416a <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff2:	00 
    1ff3:	c7 44 24 04 1e 4f 00 	movl   $0x4f1e,0x4(%esp)
    1ffa:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    206a:	00 
    206b:	c7 04 24 a0 4f 00 00 	movl   $0x4fa0,(%esp)
  ...
  if(fd < 0){
    ...
    2080:	c7 44 24 04 a9 4f 00 	movl   $0x4fa9,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 d6 20 00 00       	call   416a <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    20a0:	00 
    20a1:	c7 44 24 04 c1 4f 00 	movl   $0x4fc1,0x4(%esp)
    20a8:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c6:	00 
    20c7:	c7 04 24 c4 4f 00 00 	movl   $0x4fc4,(%esp)
  ...
  if(fd < 0){
    ...
    20dc:	c7 44 24 04 d0 4f 00 	movl   $0x4fd0,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 7a 20 00 00       	call   416a <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2124:	c7 44 24 04 e9 4f 00 	movl   $0x4fe9,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 32 20 00 00       	call   416a <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227e:	00 
    227f:	c7 04 24 04 50 00 00 	movl   $0x5004,(%esp)
  ...
  if(fd < 0){
    ...
    2294:	c7 44 24 04 ce 50 00 	movl   $0x50ce,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 c2 1e 00 00       	call   416a <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22cd:	c7 44 24 04 e6 50 00 	movl   $0x50e6,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 89 1e 00 00       	call   416a <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 60 53 00 	movl   $0x5360,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 a4 1a 00 00       	call   416a <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 6f 53 00 00 	movl   $0x536f,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 6f 53 00 00 	movl   $0x536f,(%esp)
    ...
    26fb:	c7 44 24 04 78 53 00 	movl   $0x5378,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 5b 1a 00 00       	call   416a <printf>
      exit();
    ...
    2750:	c7 44 24 04 90 53 00 	movl   $0x5390,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 06 1a 00 00       	call   416a <printf>
        exit();
    ...
    unlink("bigwrite");
    277e:	c7 04 24 6f 53 00 00 	movl   $0x536f,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 a2 53 00 	movl   $0x53a2,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 b8 19 00 00       	call   416a <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 af 53 00 	movl   $0x53af,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 9c 19 00 00       	call   416a <printf>

  unlink("bigfile");
    27ce:	c7 04 24 bd 53 00 00 	movl   $0x53bd,(%esp)
    27d5:	e8 60 18 00 00       	call   403a <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 bd 53 00 00 	movl   $0x53bd,(%esp)
  ...
  if(fd < 0){
    ...
    27f7:	c7 44 24 04 c5 53 00 	movl   $0x53c5,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 5f 19 00 00       	call   416a <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2856:	c7 44 24 04 db 53 00 	movl   $0x53db,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 00 19 00 00       	call   416a <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288b:	00 
    288c:	c7 04 24 bd 53 00 00 	movl   $0x53bd,(%esp)
  ...
  if(fd < 0){
    ...
    28a1:	c7 44 24 04 f1 53 00 	movl   $0x53f1,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 b5 18 00 00       	call   416a <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28ec:	c7 44 24 04 06 54 00 	movl   $0x5406,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 6a 18 00 00       	call   416a <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 1b 54 00 	movl   $0x541b,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 27 18 00 00       	call   416a <printf>
      exit();
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 2f 54 00 	movl   $0x542f,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 da 17 00 00       	call   416a <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    29a4:	c7 44 24 04 48 54 00 	movl   $0x5448,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 b2 17 00 00       	call   416a <printf>
    exit();
    29b8:	e8 2d 16 00 00       	call   3fea <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 bd 53 00 00 	movl   $0x53bd,(%esp)
    29c4:	e8 71 16 00 00       	call   403a <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 62 54 00 	movl   $0x5462,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 8d 17 00 00       	call   416a <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a52:	00 
    2a53:	c7 04 24 00 55 00 00 	movl   $0x5500,(%esp)
  ...
  if(fd < 0){
    ...
    2a68:	c7 44 24 04 30 55 00 	movl   $0x5530,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 ee 16 00 00       	call   416a <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a93:	00 
    2a94:	c7 04 24 70 55 00 00 	movl   $0x5570,(%esp)
  ...
  if(fd < 0){
    ...
    2aa9:	c7 44 24 04 a0 55 00 	movl   $0x55a0,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 ad 16 00 00       	call   416a <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 37 57 00 	movl   $0x5737,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 a3 14 00 00       	call   416a <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 44 57 00 00 	movl   $0x5744,(%esp)
  ...
  if(fd < 0){
    ...
    2ce4:	c7 44 24 04 4c 57 00 	movl   $0x574c,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 72 14 00 00       	call   416a <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d38:	00 
    2d39:	c7 04 24 7d 57 00 00 	movl   $0x577d,(%esp)
  ...
  if(fd >= 0){
    ...
    2d4e:	c7 44 24 04 88 57 00 	movl   $0x5788,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 08 14 00 00       	call   416a <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d6e:	00 
    2d6f:	c7 04 24 7d 57 00 00 	movl   $0x577d,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e50:	00 
    2e51:	c7 04 24 c3 4d 00 00 	movl   $0x4dc3,(%esp)
  ...
  if(fd >= 0){
    ...
    2e66:	c7 44 24 04 20 58 00 	movl   $0x5820,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 f0 12 00 00       	call   416a <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eb5:	c7 44 24 04 3f 58 00 	movl   $0x583f,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 a1 12 00 00       	call   416a <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 53 58 00 	movl   $0x5853,0x4(%esp)
    2ee0:	00 
    2ee1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee8:	e8 7d 12 00 00       	call   416a <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 63 58 00 	movl   $0x5863,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 61 12 00 00       	call   416a <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb6:	00 
    2fb7:	c7 04 24 a3 58 00 00 	movl   $0x58a3,(%esp)
    ...
    unlink("xx");
    2fd7:	c7 04 24 a3 58 00 00 	movl   $0x58a3,(%esp)
  ...
  chdir("/");
    2ff1:	c7 04 24 aa 45 00 00 	movl   $0x45aa,(%esp)
    2ff8:	e8 5d 10 00 00       	call   405a <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 a6 58 00 	movl   $0x58a6,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 59 11 00 00       	call   416a <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 ba 58 00 	movl   $0x58ba,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 3d 11 00 00       	call   416a <printf>
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 c8 58 00 	movl   $0x58c8,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 ef 10 00 00       	call   416a <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    308b:	c7 44 24 04 ea 58 00 	movl   $0x58ea,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 cb 10 00 00       	call   416a <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b8:	c7 44 24 04 fe 58 00 	movl   $0x58fe,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 9e 10 00 00       	call   416a <printf>
    exit();
    30cc:	e8 19 0f 00 00       	call   3fea <exit>
  }

  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 11 59 00 	movl   $0x5911,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 85 10 00 00       	call   416a <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 98 64 00 00       	mov    0x6498,%eax
    30f6:	c7 44 24 04 1f 59 00 	movl   $0x591f,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 64 10 00 00       	call   416a <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    3144:	a1 98 64 00 00       	mov    0x6498,%eax
    ...
    315e:	c7 44 24 04 2a 59 00 	movl   $0x592a,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 fc 0f 00 00       	call   416a <printf>
      exit();
  ...
  if(pid < 0){
    ...
    319d:	a1 98 64 00 00       	mov    0x6498,%eax
    31a2:	c7 44 24 04 45 59 00 	movl   $0x5945,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 b8 0f 00 00       	call   416a <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31e0:	a1 98 64 00 00       	mov    0x6498,%eax
    31e5:	c7 44 24 04 5c 59 00 	movl   $0x595c,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 75 0f 00 00       	call   416a <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    323e:	a1 98 64 00 00       	mov    0x6498,%eax
    3243:	c7 44 24 04 78 59 00 	movl   $0x5978,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 17 0f 00 00       	call   416a <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3289:	a1 98 64 00 00       	mov    0x6498,%eax
    328e:	c7 44 24 04 b6 59 00 	movl   $0x59b6,0x4(%esp)
    3295:	00 
    3296:	89 04 24             	mov    %eax,(%esp)
    3299:	e8 cc 0e 00 00       	call   416a <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 98 64 00 00       	mov    0x6498,%eax
    ...
    32d2:	c7 44 24 04 d4 59 00 	movl   $0x59d4,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 88 0e 00 00       	call   416a <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3326:	a1 98 64 00 00       	mov    0x6498,%eax
    ...
    3339:	c7 44 24 04 0c 5a 00 	movl   $0x5a0c,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 21 0e 00 00       	call   416a <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3358:	a1 98 64 00 00       	mov    0x6498,%eax
    335d:	c7 44 24 04 34 5a 00 	movl   $0x5a34,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 fd 0d 00 00       	call   416a <printf>
    exit();
  ...
  if(c != a){
    ...
    33a7:	a1 98 64 00 00       	mov    0x6498,%eax
    ...
    33ba:	c7 44 24 04 64 5a 00 	movl   $0x5a64,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 a0 0d 00 00       	call   416a <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 98 64 00 00       	mov    0x6498,%eax
    33f3:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 67 0d 00 00       	call   416a <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346f:	c7 44 24 04 aa 49 00 	movl   $0x49aa,0x4(%esp)
    3476:	00 
    3477:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347e:	e8 e7 0c 00 00       	call   416a <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d2:	00 
    34d3:	c7 44 24 04 0f 4a 00 	movl   $0x4a0f,0x4(%esp)
    34da:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 98 64 00 00       	mov    0x6498,%eax
    3578:	c7 44 24 04 9e 5a 00 	movl   $0x5a9e,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 e2 0b 00 00       	call   416a <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35b9:	a1 98 64 00 00       	mov    0x6498,%eax
    35be:	c7 44 24 04 b9 5a 00 	movl   $0x5ab9,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 9c 0b 00 00       	call   416a <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 98 64 00 00       	mov    0x6498,%eax
    3604:	c7 44 24 04 c7 5a 00 	movl   $0x5ac7,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 56 0b 00 00       	call   416a <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3671:	c7 04 24 d6 5a 00 00 	movl   $0x5ad6,(%esp)
    3678:	e8 cd 09 00 00       	call   404a <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 98 64 00 00       	mov    0x6498,%eax
    3687:	c7 44 24 04 e1 5a 00 	movl   $0x5ae1,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 d3 0a 00 00       	call   416a <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 98 64 00 00       	mov    0x6498,%eax
    36b4:	c7 44 24 04 fa 5a 00 	movl   $0x5afa,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 a6 0a 00 00       	call   416a <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36cc:	a1 98 64 00 00       	mov    0x6498,%eax
    36d1:	c7 44 24 04 07 5b 00 	movl   $0x5b07,0x4(%esp)
    36d8:	00 
    36d9:	89 04 24             	mov    %eax,(%esp)
    36dc:	e8 89 0a 00 00       	call   416a <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    36f9:	a1 98 64 00 00       	mov    0x6498,%eax
    36fe:	c7 44 24 04 11 5b 00 	movl   $0x5b11,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 5c 0a 00 00       	call   416a <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 98 64 00 00       	mov    0x6498,%eax
    3726:	c7 44 24 04 22 5b 00 	movl   $0x5b22,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 34 0a 00 00       	call   416a <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 2f 5b 00 00 	movl   $0x5b2f,(%esp)
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 c0 64 00 00 	movl   $0x5b3c,0x64c0(,%eax,4)
    376f:	3c 5b 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    3787:	a1 98 64 00 00       	mov    0x6498,%eax
    378c:	c7 44 24 04 19 5c 00 	movl   $0x5c19,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 ce 09 00 00       	call   416a <printf>
    exec("echo", args);
    379c:	c7 44 24 04 c0 64 00 	movl   $0x64c0,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 38 45 00 00 	movl   $0x4538,(%esp)
    37ab:	e8 72 08 00 00       	call   4022 <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 98 64 00 00       	mov    0x6498,%eax
    37b5:	c7 44 24 04 26 5c 00 	movl   $0x5c26,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 a5 09 00 00       	call   416a <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 2f 5b 00 00 	movl   $0x5b2f,(%esp)
    ...
    37f2:	a1 98 64 00 00       	mov    0x6498,%eax
    37f7:	c7 44 24 04 36 5c 00 	movl   $0x5c36,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 63 09 00 00       	call   416a <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3818:	00 
    3819:	c7 04 24 2f 5b 00 00 	movl   $0x5b2f,(%esp)
  ...
  if(fd < 0){
    ...
    382e:	a1 98 64 00 00       	mov    0x6498,%eax
    3833:	c7 44 24 04 4f 5c 00 	movl   $0x5c4f,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 27 09 00 00       	call   416a <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3853:	c7 04 24 2f 5b 00 00 	movl   $0x5b2f,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 64 5c 00 	movl   $0x5c64,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 e7 08 00 00       	call   416a <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3959:	c7 44 24 04 71 5c 00 	movl   $0x5c71,0x4(%esp)
    3960:	00 
    3961:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3968:	e8 fd 07 00 00       	call   416a <printf>
    ...
    3990:	c7 44 24 04 7d 5c 00 	movl   $0x5c7d,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 c6 07 00 00       	call   416a <printf>
      break;
    ...
    39dc:	c7 44 24 04 8d 5c 00 	movl   $0x5c8d,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 7a 07 00 00       	call   416a <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 9d 5c 00 	movl   $0x5c9d,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 56 06 00 00       	call   416a <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3b2a:	c7 44 24 04 b3 5c 00 	movl   $0x5cb3,0x4(%esp)
    3b31:	00 
    3b32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b39:	e8 2c 06 00 00       	call   416a <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    3b6f:	c7 44 24 04 c0 5c 00 	movl   $0x5cc0,0x4(%esp)
    3b76:	00 
    3b77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b7e:	e8 e7 05 00 00       	call   416a <printf>
    exit();
    ...
    printf (1, "fork failed\n");
    3b8e:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
    3b95:	00 
    3b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b9d:	e8 c8 05 00 00       	call   416a <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    3bac:	c7 44 24 04 e1 5c 00 	movl   $0x5ce1,0x4(%esp)
    3bb3:	00 
    3bb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3bbb:	e8 aa 05 00 00       	call   416a <printf>
}
    3bc0:	c9                   	leave  
    3bc1:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3bcf:	00 
    3bd0:	c7 04 24 f0 5c 00 00 	movl   $0x5cf0,(%esp)
  ...
  if (fd < 0) {
    ...
    3be5:	c7 44 24 04 f5 5c 00 	movl   $0x5cf5,0x4(%esp)
    3bec:	00 
    3bed:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bf4:	e8 71 05 00 00       	call   416a <printf>
    exit();
  ...
  printf(1, "arg test passed\n");
    3c2f:	c7 44 24 04 02 5d 00 	movl   $0x5d02,0x4(%esp)
    3c36:	00 
    3c37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c3e:	e8 27 05 00 00       	call   416a <printf>
}
    3c43:	c9                   	leave  
    3c44:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c48:	a1 9c 64 00 00       	mov    0x649c,%eax
    3c4d:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3c53:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3c58:	a3 9c 64 00 00       	mov    %eax,0x649c
  return randstate;
    3c5d:	a1 9c 64 00 00       	mov    0x649c,%eax
}
    3c62:	5d                   	pop    %ebp
    3c63:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3cb9:	00 
    3cba:	c7 04 24 27 5d 00 00 	movl   $0x5d27,(%esp)
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    4096:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    409d:	00 
    409e:	8d 45 f4             	lea    -0xc(%ebp),%eax
    40a1:	89 44 24 04          	mov    %eax,0x4(%esp)
    40a5:	8b 45 08             	mov    0x8(%ebp),%eax
    40a8:	89 04 24             	mov    %eax,(%esp)
    40ab:	e8 5a ff ff ff       	call   400a <write>
}
    40b0:	c9                   	leave  
    40b1:	c3                   	ret    
...
{
    40b2:	55                   	push   %ebp
    40b3:	89 e5                	mov    %esp,%ebp
    40b5:	56                   	push   %esi
    40b6:	53                   	push   %ebx
    40b7:	83 ec 30             	sub    $0x30,%esp
  ...
  neg = 0;
    40ba:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    40c1:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    40c5:	74 17                	je     40de <printint+0x2c>
    40c7:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    40cb:	79 11                	jns    40de <printint+0x2c>
    neg = 1;
    40cd:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    40d4:	8b 45 0c             	mov    0xc(%ebp),%eax
    40d7:	f7 d8                	neg    %eax
    40d9:	89 45 ec             	mov    %eax,-0x14(%ebp)
    40dc:	eb 06                	jmp    40e4 <printint+0x32>
  } else {
    x = xx;
  ...
  i = 0;
    40e4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    40eb:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    40ee:	8d 41 01             	lea    0x1(%ecx),%eax
    40f1:	89 45 f4             	mov    %eax,-0xc(%ebp)
    40f4:	8b 5d 10             	mov    0x10(%ebp),%ebx
    40f7:	8b 45 ec             	mov    -0x14(%ebp),%eax
    40fa:	ba 00 00 00 00       	mov    $0x0,%edx
    40ff:	f7 f3                	div    %ebx
    4101:	89 d0                	mov    %edx,%eax
    4103:	0f b6 80 a0 64 00 00 	movzbl 0x64a0(%eax),%eax
    410a:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    410e:	8b 75 10             	mov    0x10(%ebp),%esi
    4111:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4114:	ba 00 00 00 00       	mov    $0x0,%edx
    4119:	f7 f6                	div    %esi
    411b:	89 45 ec             	mov    %eax,-0x14(%ebp)
    411e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4122:	75 c7                	jne    40eb <printint+0x39>
  if(neg)
    4124:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4128:	74 10                	je     413a <printint+0x88>
    buf[i++] = '-';
    412a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    412d:	8d 50 01             	lea    0x1(%eax),%edx
    4130:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4133:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    4138:	eb 1f                	jmp    4159 <printint+0xa7>
    413a:	eb 1d                	jmp    4159 <printint+0xa7>
    putc(fd, buf[i]);
    413c:	8d 55 dc             	lea    -0x24(%ebp),%edx
    413f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4142:	01 d0                	add    %edx,%eax
    4144:	0f b6 00             	movzbl (%eax),%eax
    4147:	0f be c0             	movsbl %al,%eax
    414a:	89 44 24 04          	mov    %eax,0x4(%esp)
    414e:	8b 45 08             	mov    0x8(%ebp),%eax
    4151:	89 04 24             	mov    %eax,(%esp)
    4154:	e8 31 ff ff ff       	call   408a <putc>
  while(--i >= 0)
    4159:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    415d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4161:	79 d9                	jns    413c <printint+0x8a>
}
    4163:	83 c4 30             	add    $0x30,%esp
    4166:	5b                   	pop    %ebx
    4167:	5e                   	pop    %esi
    4168:	5d                   	pop    %ebp
    4169:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
    ...
    416d:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    4170:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    4177:	8d 45 0c             	lea    0xc(%ebp),%eax
    417a:	83 c0 04             	add    $0x4,%eax
    417d:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    4180:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    4187:	e9 7c 01 00 00       	jmp    4308 <printf+0x19e>
    c = fmt[i] & 0xff;
    418c:	8b 55 0c             	mov    0xc(%ebp),%edx
    418f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4192:	01 d0                	add    %edx,%eax
    4194:	0f b6 00             	movzbl (%eax),%eax
    4197:	0f be c0             	movsbl %al,%eax
    419a:	25 ff 00 00 00       	and    $0xff,%eax
    419f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    41a2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    41a6:	75 2c                	jne    41d4 <printf+0x6a>
      if(c == '%'){
    41a8:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    41ac:	75 0c                	jne    41ba <printf+0x50>
        state = '%';
    41ae:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    41b5:	e9 4a 01 00 00       	jmp    4304 <printf+0x19a>
      } else {
        putc(fd, c);
    ...
    41ca:	e8 bb fe ff ff       	call   408a <putc>
    41cf:	e9 30 01 00 00       	jmp    4304 <printf+0x19a>
      }
    } else if(state == '%'){
    41d4:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    41d8:	0f 85 26 01 00 00    	jne    4304 <printf+0x19a>
      if(c == 'd'){
    41de:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    41e2:	75 2d                	jne    4211 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    41e4:	8b 45 e8             	mov    -0x18(%ebp),%eax
    41e7:	8b 00                	mov    (%eax),%eax
    41e9:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    41f0:	00 
    41f1:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    41f8:	00 
    41f9:	89 44 24 04          	mov    %eax,0x4(%esp)
    41fd:	8b 45 08             	mov    0x8(%ebp),%eax
    4200:	89 04 24             	mov    %eax,(%esp)
    4203:	e8 aa fe ff ff       	call   40b2 <printint>
        ap++;
    4208:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    420c:	e9 ec 00 00 00       	jmp    42fd <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    4211:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4215:	74 06                	je     421d <printf+0xb3>
    4217:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    421b:	75 2d                	jne    424a <printf+0xe0>
        printint(fd, *ap, 16, 0);
    421d:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4220:	8b 00                	mov    (%eax),%eax
    4222:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4229:	00 
    422a:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4231:	00 
    4232:	89 44 24 04          	mov    %eax,0x4(%esp)
    4236:	8b 45 08             	mov    0x8(%ebp),%eax
    4239:	89 04 24             	mov    %eax,(%esp)
    423c:	e8 71 fe ff ff       	call   40b2 <printint>
        ap++;
    4241:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4245:	e9 b3 00 00 00       	jmp    42fd <printf+0x193>
      } else if(c == 's'){
    424a:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    424e:	75 45                	jne    4295 <printf+0x12b>
        s = (char*)*ap;
    4250:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4253:	8b 00                	mov    (%eax),%eax
    4255:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4258:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    425c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4260:	75 09                	jne    426b <printf+0x101>
          s = "(null)";
    4262:	c7 45 f4 62 5d 00 00 	movl   $0x5d62,-0xc(%ebp)
        while(*s != 0){
    4269:	eb 1e                	jmp    4289 <printf+0x11f>
    426b:	eb 1c                	jmp    4289 <printf+0x11f>
          putc(fd, *s);
    426d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    ...
    4280:	e8 05 fe ff ff       	call   408a <putc>
          s++;
    4285:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
        while(*s != 0){
    4289:	8b 45 f4             	mov    -0xc(%ebp),%eax
    428c:	0f b6 00             	movzbl (%eax),%eax
    428f:	84 c0                	test   %al,%al
    4291:	75 da                	jne    426d <printf+0x103>
    4293:	eb 68                	jmp    42fd <printf+0x193>
        }
      } else if(c == 'c'){
    4295:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4299:	75 1d                	jne    42b8 <printf+0x14e>
        putc(fd, *ap);
    ...
    42ad:	e8 d8 fd ff ff       	call   408a <putc>
        ap++;
    42b2:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42b6:	eb 45                	jmp    42fd <printf+0x193>
      } else if(c == '%'){
    42b8:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    42bc:	75 17                	jne    42d5 <printf+0x16b>
        putc(fd, c);
    42be:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    42c1:	0f be c0             	movsbl %al,%eax
    42c4:	89 44 24 04          	mov    %eax,0x4(%esp)
    42c8:	8b 45 08             	mov    0x8(%ebp),%eax
    42cb:	89 04 24             	mov    %eax,(%esp)
    42ce:	e8 b7 fd ff ff       	call   408a <putc>
    42d3:	eb 28                	jmp    42fd <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    42d5:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    42dc:	00 
    42dd:	8b 45 08             	mov    0x8(%ebp),%eax
    42e0:	89 04 24             	mov    %eax,(%esp)
    42e3:	e8 a2 fd ff ff       	call   408a <putc>
        putc(fd, c);
    42e8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    42eb:	0f be c0             	movsbl %al,%eax
    42ee:	89 44 24 04          	mov    %eax,0x4(%esp)
    42f2:	8b 45 08             	mov    0x8(%ebp),%eax
    42f5:	89 04 24             	mov    %eax,(%esp)
    42f8:	e8 8d fd ff ff       	call   408a <putc>
      }
      state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4315:	0f 85 71 fe ff ff    	jne    418c <printf+0x22>
    }
  }
}
    431b:	c9                   	leave  
...
free(void *ap)
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    43a2:	8b 10                	mov    (%eax),%edx
    43a4:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43a7:	89 10                	mov    %edx,(%eax)
    43a9:	eb 0a                	jmp    43b5 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    43ab:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43ae:	8b 10                	mov    (%eax),%edx
    43b0:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43b3:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    43b5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43b8:	8b 40 04             	mov    0x4(%eax),%eax
    43bb:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    43c2:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43c5:	01 d0                	add    %edx,%eax
    43c7:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    43ca:	75 20                	jne    43ec <free+0xcf>
    p->s.size += bp->s.size;
    43cc:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43cf:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    43ea:	eb 08                	jmp    43f4 <free+0xd7>
  } else
    p->s.ptr = bp;
    43ec:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43ef:	8b 55 f8             	mov    -0x8(%ebp),%edx
    43f2:	89 10                	mov    %edx,(%eax)
  freep = p;
    43f4:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43f7:	a3 48 65 00 00       	mov    %eax,0x6548
}
    43fc:	c9                   	leave  
    43fd:	c3                   	ret    
...
{
    43fe:	55                   	push   %ebp
    43ff:	89 e5                	mov    %esp,%ebp
    4401:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    4404:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    440b:	77 07                	ja     4414 <morecore+0x16>
    nu = 4096;
    440d:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4414:	8b 45 08             	mov    0x8(%ebp),%eax
    4417:	c1 e0 03             	shl    $0x3,%eax
    441a:	89 04 24             	mov    %eax,(%esp)
    441d:	e8 50 fc ff ff       	call   4072 <sbrk>
    4422:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4425:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4429:	75 07                	jne    4432 <morecore+0x34>
    return 0;
    442b:	b8 00 00 00 00       	mov    $0x0,%eax
    4430:	eb 22                	jmp    4454 <morecore+0x56>
  hp = (Header*)p;
    4432:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4435:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    4438:	8b 45 f0             	mov    -0x10(%ebp),%eax
    443b:	8b 55 08             	mov    0x8(%ebp),%edx
    443e:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4441:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4444:	83 c0 08             	add    $0x8,%eax
    4447:	89 04 24             	mov    %eax,(%esp)
    444a:	e8 ce fe ff ff       	call   431d <free>
  return freep;
    444f:	a1 48 65 00 00       	mov    0x6548,%eax
}
    4454:	c9                   	leave  
    4455:	c3                   	ret    
...
{
    4456:	55                   	push   %ebp
    4457:	89 e5                	mov    %esp,%ebp
    4459:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    445c:	8b 45 08             	mov    0x8(%ebp),%eax
    445f:	83 c0 07             	add    $0x7,%eax
    4462:	c1 e8 03             	shr    $0x3,%eax
    4465:	83 c0 01             	add    $0x1,%eax
    4468:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    446b:	a1 48 65 00 00       	mov    0x6548,%eax
    4470:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4473:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4477:	75 23                	jne    449c <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4479:	c7 45 f0 40 65 00 00 	movl   $0x6540,-0x10(%ebp)
    4480:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4483:	a3 48 65 00 00       	mov    %eax,0x6548
    4488:	a1 48 65 00 00       	mov    0x6548,%eax
    448d:	a3 40 65 00 00       	mov    %eax,0x6540
    base.s.size = 0;
    4492:	c7 05 44 65 00 00 00 	movl   $0x0,0x6544
    4499:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    449c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    449f:	8b 00                	mov    (%eax),%eax
    44a1:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    44a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44a7:	8b 40 04             	mov    0x4(%eax),%eax
    44aa:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    44ad:	72 4d                	jb     44fc <malloc+0xa6>
      if(p->s.size == nunits)
    44af:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44b2:	8b 40 04             	mov    0x4(%eax),%eax
    44b5:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    44b8:	75 0c                	jne    44c6 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    44ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44bd:	8b 10                	mov    (%eax),%edx
    44bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44c2:	89 10                	mov    %edx,(%eax)
    44c4:	eb 26                	jmp    44ec <malloc+0x96>
      else {
        p->s.size -= nunits;
    44c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44c9:	8b 40 04             	mov    0x4(%eax),%eax
    44cc:	2b 45 ec             	sub    -0x14(%ebp),%eax
    44cf:	89 c2                	mov    %eax,%edx
    44d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44d4:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    44d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44da:	8b 40 04             	mov    0x4(%eax),%eax
    44dd:	c1 e0 03             	shl    $0x3,%eax
    44e0:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    44e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44e6:	8b 55 ec             	mov    -0x14(%ebp),%edx
    44e9:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    44ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44ef:	a3 48 65 00 00       	mov    %eax,0x6548
      return (void*)(p + 1);
    44f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44f7:	83 c0 08             	add    $0x8,%eax
    44fa:	eb 38                	jmp    4534 <malloc+0xde>
    }
    if(p == freep)
    44fc:	a1 48 65 00 00       	mov    0x6548,%eax
    4501:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4504:	75 1b                	jne    4521 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4506:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4509:	89 04 24             	mov    %eax,(%esp)
    450c:	e8 ed fe ff ff       	call   43fe <morecore>
    4511:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4514:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4518:	75 07                	jne    4521 <malloc+0xcb>
        return 0;
    451a:	b8 00 00 00 00       	mov    $0x0,%eax
    451f:	eb 13                	jmp    4534 <malloc+0xde>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4521:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4524:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4527:	8b 45 f4             	mov    -0xc(%ebp),%eax
    452a:	8b 00                	mov    (%eax),%eax
    452c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  }
    452f:	e9 70 ff ff ff       	jmp    44a4 <malloc+0x4e>
}
    4534:	c9                   	leave  
    4535:	c3                   	ret    
